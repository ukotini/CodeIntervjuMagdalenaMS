...
--      Found_Threats : Threat_Side;
--  begin
--      -- Oppdatere trusselside fra sensorene
--      Found_Threats := detectThreat;

--      -- Case for én sensortrussel
--      if Found_Threats.Front and not (Found_Threats.Right or Found_Threats.Left or Found_Threats.Back) then
--          if SharedDataSense.Get_Sensor_Front <= 35 then
--              command := Drive_Backwards;
--              Put_Line("Threat Front, Drive Back");
--          else
...
--      elsif Found_Threats.Right and not (Found_Threats.Front or Found_Threats.Left or Found_Threats.Back) then
--          if SharedDataSense.Get_Sensor_Right <= 35 then
--              command := Drive_Lateral_Left;
--              Put_Line("Threat Right, Drive Left");
--          else
...
--      elsif Found_Threats.Left and not (Found_Threats.Front or Found_Threats.Right or Found_Threats.Back) then
--          if SharedDataSense.Get_Sensor_Left <= 35 then
--              command := Drive_Lateral_Right;
--              Put_Line("Threat Left, Drive Right");
--          else
...
--      elsif Found_Threats.Back and not (Found_Threats.Front or Found_Threats.Left or Found_Threats.Right) then
--          if SharedDataSense.Get_Sensor_Back <= 35 then
--              command := Drive_Forward;
--              Put_Line("Threat Back, Drive Forward");
--          else
...
--      -- Case for to sensortrusler
--      elsif Found_Threats.Front and Found_Threats.Right then
--          command := Drive_Lateral_Left;
--          Put_Line("Threat Front & Right, Drive Left");

--      elsif Found_Threats.Front and Found_Threats.Left then
--          command := Drive_Lateral_Right;
--          Put_Line("Threat Front & Left, Drive Right");

--      elsif Found_Threats.Back and Found_Threats.Right then
--          command := Drive_Lateral_Left;
--          Put_Line("Threat Back & Right, Drive Left");

--      elsif Found_Threats.Back and Found_Threats.Left then
--          command := Drive_Lateral_Right;
--          Put_Line("Threat Back & Left, Drive Right");

--      -- Case for tre sensortrusler
--      elsif Found_Threats.Front and Found_Threats.Right and Found_Threats.Left then
--          command := Drive_Backwards;
--          Put_Line("Threat Front, Right & Left, Drive Backwards");

--      elsif Found_Threats.Back and Found_Threats.Right and Found_Threats.Left then
--          command := Drive_Forward;
--          Put_Line("Threat Back, Right & Left, Drive Forward");

--      -- Ingen trussel oppdaget
--     if not Found_Threats.Back and not Found_Threats.Front and not Found_Threats.Left and not Found_Threats.Right then
--          command := Drive_Forward;
--          Put_Line("There is no threat");
--        end if;
